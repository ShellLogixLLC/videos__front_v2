...
const ActiveCategory: React.FC = () => {
  ...
  const activeCategoryName =
    query.name === ActiveCategoryRoute.Most_Viewed
      ? CategoryFilters.MostViewed
      : query.name === ActiveCategoryRoute.Most_Liked
  ...
  const mostLiked = query?.name === ActiveCategoryRoute.Most_Liked ? -1 : '';
  const mostViewed = query?.name === ActiveCategoryRoute.Most_Viewed ? -1 : '';
